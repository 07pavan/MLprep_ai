  ...
  return (
    ...
    >
      ...
      <Icon
        ...
        style={{
          flexShrink: 0,
          color: isActive ? 'var(--accent-2)' : 'inherit',
  ...
  return (
    <>
      <style>{`
        ...
        .sidebar-scroll::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.07); border-radius: 3px; }
      ...
      <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-primary)' }}>
            ...
            <div style={{ padding: '8px 12px 4px', flexShrink: 0 }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: 9,
                  background: datasetMeta ? 'transparent' : 'rgba(217,119,6,0.08)',
                  border: `1px solid ${datasetMeta ? 'rgba(255,255,255,0.07)' : 'rgba(217,119,6,0.2)'}`,
                  color: datasetMeta ? 'var(--text-muted)' : 'var(--accent-2)',
                ...
                onMouseLeave={e => {
                  e.currentTarget.style.background = datasetMeta ? 'transparent' : 'rgba(217,119,6,0.08)'
                  e.currentTarget.style.borderColor = datasetMeta ? 'rgba(255,255,255,0.07)' : 'rgba(217,119,6,0.2)'
                  e.currentTarget.style.color = datasetMeta ? 'var(--text-muted)' : 'var(--accent-2)'
                }}
              >
            ...
            >
              ...
              {!collapsed && (
                <span style={{
                  ...
                  borderRadius: 99, background: 'rgba(217,119,6,0.12)',
        ...
        >
          ...
          <div style={{ padding: '12px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '4px 6px' }}>
              ...
              <button onClick={logOut} style={{ width: 26, height: 26, borderRadius: 6, background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)', color: '#ef4444', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
                <LogOut size={12} />
              </button>
            </div>
          </div>
        ...
        >
          <button
            ...
            style={{ color: 'var(--text-primary)', padding: 6, borderRadius: 7, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', cursor: 'pointer' }}
          >
            <Menu size={19} />
          </button>
          ...
          {datasetMeta && (
            <span style={{
              ...
              fontSize: '0.68rem', color: 'var(--accent-2)', fontWeight: 600,
              overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
              maxWidth: '40vw',
            }}>
              {datasetMeta.filename}
        ...
        <div
          ...
          style={{
            ...
            height: 64,
            background: 'rgba(14,13,11,0.95)', backdropFilter: 'blur(20px)',
            borderTop: '1px solid rgba(255,255,255,0.05)',
          ...
          {ALL_NAV.slice(0, 5).map(({ id, label, icon: Icon }) => (
            <button
              ...
              style={{
                ...
                color: activePage === id ? 'var(--accent-2)' : 'var(--text-muted)',
                fontSize: '0.6rem', fontWeight: 600,
                cursor: 'pointer', background: 'none', border: 'none', fontFamily: 'inherit',
                transition: 'all 0.18s ease',
              }}
            >
              <Icon size={20} style={{ opacity: activePage === id ? 1 : 0.6 }} />
              <span>{label}</span>
            </button>
          ))}
          <button
